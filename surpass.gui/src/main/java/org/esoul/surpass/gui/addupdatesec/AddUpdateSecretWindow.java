...
public class AddUpdateSecretWindow {
	...
	public static void createAndShowUpdate(JFrame parentFrame, AddUpdateSecretListener listener, BiConsumer<char[], Collection<CharClass>> secretGenerator, String identifier, String note) {
		AddUpdateSecretComponents components = new AddUpdateSecretComponents();
